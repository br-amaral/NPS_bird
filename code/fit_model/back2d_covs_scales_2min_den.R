...
script_name <- "back2d_covs_scales_2min_den.R"
...
model_file <- "models/mod_1_vector1spsparks_simple_3covs_a0s_scales_den.txt"
mod_name <- glue("data/ana_file/{date_out}_mod_{sps_name}_{park_name}_den.txt") %>% as.character()
...
file_name <- glue("{date_out}_{fil_nam}_{park_name}_{niterations}its_2min_den_")
