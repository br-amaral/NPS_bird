    ...
    for(j in 1:nsiteM){       # site j	
      for(t in 1:nyrM){       # year t	
        ...
        logit(psi[r,i,j,t]) <- beta0[r,i] + 	
                             beta1[r,i] * x1[r,scales_beta1] # that would be same scale accross sites at once
...
write_rds(jags_model, 
          file = glue("data/model_res/M10_1.rds"))
...
write_rds(samples_jags, 
          file = glue("data/model_res/M10_2.rds"))
