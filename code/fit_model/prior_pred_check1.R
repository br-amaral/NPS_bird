...
for (key_ite in 1:nrow(master_tab)){
    ...
    write_rds(out_prior, file = glue("data/ana_file/prior_predictive_check_{sps_loop}_{date_step1}.rds"))
    ...
    # Save as SVG file
    svg_filename <- glue("figures/prior_predictive_check_{sps_loop}_{date_step1}.svg")
