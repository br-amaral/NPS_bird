    ...
    for(j in 1:nsiteM){       # site j	
      for(t in 1:nyrM){       # year t	
        ...
        logit(psi[r,j,t]) <- beta0[r] + 	
                             beta1[r] * x1[r,5] # that would be same scale accross sites at once
...
write_rds(jags_model, 
          file = glue("data/model_res/M08.rds"))
