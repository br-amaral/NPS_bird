...
#           - data/out/key_bsite.rds        : forest type classification for each bird site
#           - data/out/key_fsite.rds        : forest type classification for each forest plot
#           - data/out/updated_for_cats.csv : vegetation types/categories of the parks - detailed to be classified in forest/not forest
#           - data/out/NETNtib.rds          : NETN bird data
#           - data/out/park_site_UTM.rds    : UTM coordinates of sites within each park
