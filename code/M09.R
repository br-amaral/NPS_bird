...
write_rds(jags_model, 
          file = glue("data/model_res/M09_1.rds"))
...
write_rds(samples_jags, 
          file = glue("data/model_res/M09_2.rds"))
