...
- <b>[data](#data)</b>: all data used in the analysis, including processed outputs. Divided into:
    - <b>[ana_file](#ana_file)</b>: folder to save the processed species-specific bird data used in the model, the metadata about the model run (e.g. number of iterations and initial values).
    ...
    - <b>[model_res](#model_res)</b>: JAGS model output files per species for steps 1 and 2.
