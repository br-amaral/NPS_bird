...
samples_jags <- read_rds(file = "jags_modeloct30_scales50000.rds")
samples_jags <- read_rds(file = "jags_modeloct30_scales2.rds")


MCMCsummary(samples_jags,
            params = c("mu.alpha0", "mu.alpha1", "mu.alpha2", "mu.alpha3",
                       "mu.beta0", "mu.beta2", "mu.beta3",
                       "scales_beta2", "scales_beta3"),
            round = 2)
